...
Then open the local `/docs` route using the host and port selected for your development environment. The Swagger UI allows you to test endpoints without writing code. Click `Authorize` and enter your configured `API_KEY`.
